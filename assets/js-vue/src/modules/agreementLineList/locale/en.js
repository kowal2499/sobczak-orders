export default {
    trashOrder: 'Throw into trash',
    trashConfirmQuestion: 'Are you sure to throw this order into trash: "{num}"?',
    setAsArchived: 'Please confirm status change into "Archived"?',
    startProductionForm: {
        modalTitle: 'Production dates per department',
