export default {
    ...
    '_unsavedChangesConfirm': 'Masz niezapisane zmiany. Czy na pewno chcesz je odrzucić?',
    '_discardChanges': 'Odrzuć zmiany',
    '_continueEditing': 'Kontynuuj edycję',
    '_agreementLineStatus': 'Status zamówienia',
    '_productionStatus': 'Status produkcji',
    '_status_agreement__waiting': 'Oczekujące',
    '_status_agreement__manufacturing': 'W realizacji',
    '_status_agreement__warehouse': 'Magazyn',
    '_status_agreement__archived': 'Archiwum',
    '_status_agreement__deleted': 'Kosz',
    ...
    'listing': {
        ...
        'unsavedFilters': 'Niezapisane zmiany',
        'savedInView': 'Zapisane w widoku „{title}"',
        'saveFilters': 'Zapisz w widoku',
        'restoreFilters': 'Przywróć',
