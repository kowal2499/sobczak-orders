export default {
    ...
    '_unsavedChangesConfirm': 'You have unsaved changes. Are you sure you want to discard them?',
    '_discardChanges': 'Discard changes',
    '_continueEditing': 'Continue editing',
    '_agreementLineStatus': 'Order status',
    '_productionStatus': 'Production status',
    '_status_agreement__waiting': 'Waiting',
    '_status_agreement__manufacturing': 'In realization',
    '_status_agreement__warehouse': 'Warehouse',
    '_status_agreement__archived': 'Archived',
    '_status_agreement__deleted': 'Deleted',
    ...
    'listing': {
        ...
        'filters': 'Filters',
        'clearFilters': 'Clear',
        'unsavedFilters': 'Unsaved changes',
        'savedInView': 'Saved in the "{title}" view',
        'saveFilters': 'Save in the view',
    ...
    '_validation': {
        ...
        'dateFromOrEqual': 'The start date must be earlier than or equal to the end date',
        'dateToOrEqual': 'The end date must be later than or equal to the start date',
