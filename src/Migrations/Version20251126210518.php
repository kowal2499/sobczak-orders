...
final class Version20251126210518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE production_factor_adjustment (id INT AUTO_INCREMENT NOT NULL, production_id INT DEFAULT NULL, description VARCHAR(512) NOT NULL, factor DOUBLE PRECISION DEFAULT NULL, INDEX IDX_FC0E6521ECC6147F (production_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE production_factor_adjustment');
    }
}
